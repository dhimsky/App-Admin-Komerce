class cariOrder {
  ...
  cariOrder({required this.status, required this.code, required this.data});

  factory cariOrder.fromJson(Map<String, dynamic> json) {
    return cariOrder(
      status: json['status'],
      code: json['code'],
...
class OrderData {
  ...
  final double cashbackTo;
  final double totalWeight;
  final double percentageCostRetur;
  final double shippingRetur;
  final String notes;
  final Ticket ticket;
  ...
  factory OrderData.fromJson(Map<String, dynamic> json) {
    return OrderData(
      ...
      oldGrandtotal: json['old_grandtotal'].toDouble(),
      isEdited: json['is_edited'],
      shippingCashback: json['shipping_cashback'].toDouble(),
      ...
      cashbackTo: json['cashback_to'].toDouble(),
      totalWeight: json['total_weight'].toDouble(),
      percentageCostRetur: json['percentage_cost_retur'].toDouble(),
      shippingRetur: json['shipping_retur'].toDouble(),
      notes: json['notes'],
      ticket: Ticket.fromJson(json['ticket']),
      customLabel: json['custom_label'],
      addressPartner: List<AddressPartner>.from(
        json['address_partner'].map((x) => AddressPartner.fromJson(x)),
      ),
      senderBrand: List<SenderBrand>.from(
        json['sender_brand'].map((x) => SenderBrand.fromJson(x)),
      ),
